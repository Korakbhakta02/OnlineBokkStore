  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        ...
        <p class="lead"> An online book store that allows users to
search and purchase a book based on title, author and subject. The selected books are
displayed in a tabular format and the user can order their books online. The Administrator will have additional functionalities when compared to the
common user. </p>
